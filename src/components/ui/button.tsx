...
// --- Marketing LinkButton -------------------------------------------------
// Preserved from the original SUME button (a Next.js <Link> styled as a CTA).
// Kept separate from the shadcn Button above so the marketing site's styling
// is unchanged.
...
const linkButtonVariants: Record<LinkButtonVariant, string> = {
  primary:
...
function LinkButton({
  ...
  return (
    <Link
      className={cn(linkButtonBase, linkButtonVariants[variant], className)}
      {...props}
    />
  )
}
