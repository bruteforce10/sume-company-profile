...
insert into public.translation_messages (namespace, key, locale, value) values
  ...
  ('Home', 'positioningHeadingStrong', 'id', 'Infrastruktur mekanikal & elektrikal'),
  ('Home', 'positioningHeadingRest', 'id', 'untuk fasilitas mission-critical.'),
  ('Home', 'positioningBody', 'id', 'SUME merancang, memasang, dan memelihara sistem kelistrikan, pendinginan, dan monitoring yang menjaga data center, properti komersial, dan fasilitas industri tetap beroperasi — tanpa gangguan.'),
  ('Home', 'solutionsEyebrow', 'id', 'Solusi Kami'),
  ...
  ('Home', 'contactHeading', 'id', 'Hubungi Kami'),
  ('Home', 'contactBody', 'id', 'Siap memulai proyek engineering Anda berikutnya? Para ahli kami siap memberikan konsultasi mendetail untuk kebutuhan M&E spesifik Anda.'),
  ...
  ('AboutPage', 'missionP1', 'id', 'PT. SUME (Solusi Utama Mekanikal Elektrikal) bermula sebagai kontraktor mekanikal dan elektrikal dengan satu keyakinan sederhana: bahwa sistem di balik sebuah bangunan — kelistrikan, pendinginan, dan kontrolnya — layak mendapat ketelitian yang sama dengan struktur bangunannya.'),
  ('AboutPage', 'missionP2', 'id', 'Selama <ph>[tahun]</ph> tahun, keyakinan itu tumbuh menjadi kapabilitas M&E yang menyeluruh. Yang bermula dari instalasi gedung komersial kini berkembang ke infrastruktur kritis — di mana SUME menghadirkan <strong>sistem kelistrikan, pendinginan, monitoring, dan keamanan terintegrasi</strong> untuk fasilitas yang beroperasi sepanjang waktu.'),
  ('AboutPage', 'missionP3', 'id', 'Kini, SUME melayani klien di seluruh Indonesia dan kawasan, didukung kantor di Singapura dan Myanmar, serta ekosistem kapabilitas spesialis yang mencakup standby power, energi surya, precision cooling, dan monitoring cerdas.'),
  ...
  ('SolutionsPage', 'integratedP1', 'id', 'Inti SUME: satu kontraktor yang bertanggung jawab penuh atas seluruh lingkup mekanikal dan elektrikal — <strong>desain, pengadaan, instalasi, commissioning, dan pemeliharaan berkelanjutan.</strong>'),
  ('SolutionsPage', 'integratedP2', 'id', 'Di saat sebagian besar proyek harus mengoordinasikan banyak spesialis, SUME menghadirkan seluruh siklus hidup M&E dalam satu garis tanggung jawab — mengurangi risiko, menyederhanakan pengerjaan, dan menjaga setiap sistem kritis tetap selaras.'),
  ...
  ('Home', 'positioningHeadingStrong', 'en', 'Mechanical & electrical infrastructure'),
  ('Home', 'positioningHeadingRest', 'en', 'for mission-critical facilities.'),
  ('Home', 'positioningBody', 'en', 'SUME designs, installs, and maintains the power, cooling, and monitoring systems that keep data centers, commercial properties, and industrial facilities running — without interruption.'),
  ('Home', 'solutionsEyebrow', 'en', 'Our Solutions'),
  ...
  ('Home', 'contactHeading', 'en', 'Get in Touch'),
  ('Home', 'contactBody', 'en', 'Ready to start your next engineering project? Our experts are here to provide a detailed consultation for your specific M&E needs.'),
  ('Projects', 'all', 'en', 'All'),
  ...
  ('AboutPage', 'missionP1', 'en', 'PT. SUME (Solusi Utama Mekanikal Elektrikal) began as a mechanical and electrical contractor with a simple conviction: that the systems behind a building — its power, its cooling, its controls — deserve the same rigor as the structure itself.'),
  ('AboutPage', 'missionP2', 'en', 'Over <ph>[years]</ph> years, that conviction has grown into a comprehensive M&E capability. What started with commercial building installations has expanded into critical infrastructure — where SUME now delivers <strong>integrated power, cooling, monitoring, and security systems</strong> for facilities that operate around the clock.'),
  ('AboutPage', 'missionP3', 'en', 'Today, SUME serves clients across Indonesia and the region, supported by offices in Singapore and Myanmar, and an ecosystem of specialized capabilities spanning standby power, solar energy, precision cooling, and intelligent monitoring.'),
  ...
  ('SolutionsPage', 'integratedP1', 'en', 'SUME''s core: a single accountable contractor across the full mechanical and electrical scope — <strong>design, procurement, installation, commissioning, and ongoing maintenance.</strong>'),
  ('SolutionsPage', 'integratedP2', 'en', 'Where most projects coordinate across many specialists, SUME delivers the entire M&E lifecycle under one line of accountability — reducing risk, simplifying delivery, and keeping every critical system aligned.'),
